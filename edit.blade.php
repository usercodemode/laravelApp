                ...
                <div class="p-5 bg-white shadow-md login rounded-2xl">
                    <form method="POST" action="/update/{{ $post->id }}">
                        ...
                        <label class="block">
                            ...
                            <input type="text" name="title" placeholder="..." value="{{ $post->title }}"
                    ...
                    @enderror
                            ...
                            <input type="checkbox" name="is_published" value="0"
                             ...
                             @else
                                                         <input type="checkbox" name="is_published" value="0"
                                class="block w-1/2 px-3 py-2 mt-1 text-sm bg-white border rounded-md shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500 " checked/>
                            @endif
                                ...
                                @enderror
                                                        ...
                                                        <span class="block text-sm font-medium text-slate-700">Private Key</span>
                            <!-- Using form state modifiers, the classes can be identical for every input -->
                            @inject('decrypt', 'Illuminate\Support\Facades\Crypt')
                            <input type="text" name="key" placeholder="..." value="{{ Crypt::decrypt($post->key) }}"
                                class="block w-1/2 px-3 py-2 mt-1 text-sm bg-white border rounded-md shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500 " />
