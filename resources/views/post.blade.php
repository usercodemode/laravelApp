    ...
    <main class="h-full">
        ...
        <div class="container px-4 mx-auto">
            ...
            <div class="p-2 mt-5 bg-white rounded shadow-md md:w-1/2">
                <div class="mb-2 font-mono font-bold text-xl"><a class="text-blue-500  hover:text-orange-700" href="/blog/{{ $post->id }}">{{ $post->title }}</a></div>
                        <div class="my-3">
                            <img src="{{ asset('images/'.$post->image_path) }}" class="my-2" width="30%"/>
                            <p class="font-serif my-2">{{ $post->body }}</p>
                            <p class="italic font-mono font-bold text-sm">Updated at: {{ $post->updated_at->format('d-m-y H:i:s') }}</p>
                            <p class="italic font-mono font-bold text-sm">Created at: {{ $post->created_at->format('d-m-y H:i:s') }}</p>
                        </div>
