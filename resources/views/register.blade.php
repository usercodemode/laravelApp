            ...
            <div class="grid grid-cols-1 gap-2 p-2 my-4 rounded md:grid-cols-2">
                ...
                <div class="p-5 bg-gray-100 login rounded-2xl">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <label class="block">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" placeholder="Email"
                                class="min-[300px]:w-1/2 mt-1 bblock px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                    ...
                    " />
                            ...
                            <span class="block mt-5 text-sm font-medium text-slate-700">Name</span>
                            <!-- Using form state modifiers, the classes can be identical for every input -->
                            <input type="text" name="name" value="{{ old('name') }}"
                                placeholder="Name"
                                class="min-[300px]:w-1/2 mt-1 block px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sms placeholder-slate-400
                    focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
                    disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
                    invalid:border-pink-500 invalid:text-pink-600
                    focus:invalid:border-pink-500 focus:invalid:ring-pink-500
                    " />
                            ...
                            <span class="block mt-5 text-sm font-medium text-slate-700">Password</span>
                            <input type="password" name="password" value="{{ old('password') }}"
                                placeholder="Password"
                                class="min-[300px]:w-1/2 mt-1 block px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                    focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
                    disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
                    invalid:border-pink-500 invalid:text-pink-600
                    focus:invalid:border-pink-500 focus:invalid:ring-pink-500
