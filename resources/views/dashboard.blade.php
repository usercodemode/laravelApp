            ...
            <main class="flex flex-grow px-4 py-8">
                <aside class="flex flex-col justify-between w-56 mr-4 bg-white rounded-md shadow-md">
                    <nav class="px-4 py-4 space-y-2">
                        ...
                        <a href="/blogs" class="text-base font-medium text-blue-500 hover:text-blue-800 block">Blog</a>
                        <a href="/posts" class="text-base font-medium text-blue-500 hover:text-blue-800 block">Posts</a>
